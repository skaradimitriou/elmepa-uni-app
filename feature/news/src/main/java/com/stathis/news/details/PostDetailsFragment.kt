...
import com.stathis.news.databinding.FragmentPostDetailsBinding
import com.stathis.news.details.adapter.PostDetailsAdapter
import com.stathis.news.details.generator.PostDetailsGenerator
...
class PostDetailsFragment :
    ...
    override fun init() {
        setScreenTitle(getString(com.stathis.common.R.string.post_details_title))
