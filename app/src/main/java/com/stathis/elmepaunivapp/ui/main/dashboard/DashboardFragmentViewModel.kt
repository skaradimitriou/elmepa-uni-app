...
class DashboardFragmentViewModel(app: Application) : AndroidViewModel(app), ElmepaClickListener {
    ...
    fun bindList(callback: DashboardClickListener) {
        ...
        adapter.submitList(
            listOf(DashboardOption("Ανακοινώσεις", R.drawable.ic_announcement),
