...
class DepartmentActivityKt : ElmepaActivity(R.layout.activity_department) {

    private lateinit var viewModel : DepartmentViewModelKt

    override fun init() {
        viewModel = ViewModelProvider(this).get(DepartmentViewModelKt::class.java)
    }
    ...
    override fun startOps() {
        ...
        viewModel.bindCallbacks(object : DepartmentClickListener{
            ...
            override fun openVirtualTour(data: VirtualTourModel) {
                startActivity(Intent(this@DepartmentActivityKt,WebviewActivity::class.java)
            ...
            override fun openResearch(data: ResearchKt) {
                startActivity(Intent(this@DepartmentActivityKt, ResearchActivity::class.java))
            }
        })
