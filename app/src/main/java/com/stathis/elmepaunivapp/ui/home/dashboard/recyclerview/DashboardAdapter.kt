package com.stathis.elmepaunivapp.ui.home.dashboard.recyclerview
...
class DashboardAdapter(private val callback: ElmepaClickListener) : ListAdapter<LocalModel, DashboardViewHolder>(DiffItemClass<LocalModel>()) {
