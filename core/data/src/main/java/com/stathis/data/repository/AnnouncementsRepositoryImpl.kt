...
class AnnouncementsRepositoryImpl @Inject constructor(
    ...
    override suspend fun fetchAnnouncements(forceUpdate: Boolean): Flow<NetworkResult<List<com.stathis.model.UiModel>>> =
        flow {
    ...
    override suspend fun fetchDepartmentEvents(forceUpdate: Boolean): Flow<NetworkResult<List<com.stathis.model.UiModel>>> =
        flow {
            emit(NetworkResult.Loading(ShimmerGenerator.list))
